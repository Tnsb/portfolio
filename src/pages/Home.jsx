...
export function Home() {
  return (
    <>
      <DocumentTitle title="Tina Sibbal" />
          ...
          <div className="hero__layout">
            ...
            <div className="hero__rest">
              <p className="hero__tagline">
                M.S. in AI Systems Management at <strong>Carnegie Mellon</strong>, focused on
                agentic systems, AI product strategy, and shipping production ML. Before that,
                senior software engineer at <strong>Trackonomy</strong>, a unicorn IoT logistics
                startup (last-mile visibility, APIs, and customer-facing tools).
              </p>
